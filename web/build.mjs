...
//        index.html -> app.js -> pkg/moo3_save_web.js -> *_bg.wasm
...
const wasmName = emitHashed("pkg/moo3_save_web_bg.wasm");
const pkgJsName = emitHashed("pkg/moo3_save_web.js", [
  ["moo3_save_web_bg.wasm", wasmName],
]);
const appJsName = emitHashed("app.js", [
  ["./pkg/moo3_save_web.js", `./${pkgJsName}`],
]);
